...
export const varietyDetails: Record<string, { effects: string; flavor: string; exportStatus: string }> = {
  Borogu: { effects: "Balanced relaxation, sociable, mild euphoria", flavor: "earthy", exportStatus: "Widely exported" },
  Palarasul: { effects: "Heavy body relaxation, sedating", flavor: "earthy", exportStatus: "Limited export" },
  Melomelo: { effects: "Heady, uplifting, social", flavor: "peppery", exportStatus: "Exported" },
  Ahouia: { effects: "Balanced, ceremonial grade", flavor: "earthy", exportStatus: "Limited" },
  Pia: { effects: "Mild, good for beginners", flavor: "sweet", exportStatus: "Local mainly" },
  Kelai: { effects: "Strong heady effect", flavor: "peppery", exportStatus: "Specialty export" },
  "Qila Balavu": { effects: "Strong, ceremonial, balanced", flavor: "earthy", exportStatus: "Exported" },
  Matakaro: { effects: "Relaxing, mild sedation", flavor: "earthy", exportStatus: "Limited" },
  "Loa Kasa Balavu": { effects: "Heady, social, uplifting", flavor: "peppery", exportStatus: "Specialty" },
  "Dokobana Vula": { effects: "Heavy, night-time relaxation", flavor: "earthy", exportStatus: "Limited" },
  Lekahina: { effects: "Strong, ceremonial, balanced", flavor: "earthy", exportStatus: "Exported" },
  "Leka Tefito": { effects: "Moderate, social", flavor: "sweet", exportStatus: "Limited" },
  "Tonga Lekahina": { effects: "Ceremonial strength, relaxing", flavor: "earthy", exportStatus: "Regional" },
  Aisa: { effects: "Ceremonial, strong, balanced", flavor: "earthy", exportStatus: "Limited" },
  "Aisa Ula": { effects: "Red-stem variety, potent", flavor: "peppery", exportStatus: "Specialty" },
  Fita: { effects: "Milder, social use", flavor: "sweet", exportStatus: "Local" },
  "Melo Melo": { effects: "Balanced, emerging commercial grade", flavor: "earthy", exportStatus: "Growing" },
  "PNG varieties": { effects: "Variable, local traditional use", flavor: "earthy", exportStatus: "Emerging" },
  Mahakea: { effects: "Relaxing, mild, great for beginners", flavor: "sweet", exportStatus: "Local premium" },
  Hiwa: { effects: "Black-stemmed, potent, ceremonial", flavor: "earthy", exportStatus: "Limited" },
  Nene: { effects: "Balanced, daytime use", flavor: "sweet", exportStatus: "Specialty" },
  "Mo'i": { effects: "Premium heady effect, royal variety", flavor: "peppery", exportStatus: "Premium export" },
  "Pana'ewa": { effects: "Strong body effect, relaxing", flavor: "earthy", exportStatus: "Craft market" },
};
